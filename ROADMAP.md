...
**Roadmap Version:** 1.2 (revised 2026-03-14 IST — @Since tags and deferred-scope notes added)
...
> **@Since** `v2.0-rc` &nbsp;·&nbsp; **Status:** Planned — not yet started (branching adapter stubs exist from Item 1)
